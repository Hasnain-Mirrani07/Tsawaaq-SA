...
class EditAddressPage extends StatefulWidget {
  ...
  const EditAddressPage({Key? key,this.avenue,this.building,this.addressId,this.phone,this.email,this.name,this.note,this.floor,this.street,this.block,this.area,required this.navigateFromAddresses}) : super(key: key);
...
class _EditAddressPageState extends State<EditAddressPage>
  ...
  void initState() {
    ...
    _email = "${widget.email}";
    _phone = "${widget.phone}";
    _area = "${widget.area!.name}";
    _block = "${widget.block}";
    _streetNumber = "${widget.street}";
    _buildingNo = "${widget.building}";
    _floorNo = "${widget.floor}";
    _avenue = "${widget.avenue}";
    _otherInstructions = "${widget.note}";
    // locator<AddAddressManager>().selectAreaSubject.value = Area(id:0,name:locator<PrefsService>().appLanguage == 'en' ? "Area":"المنطقة");
  }
  ...
  Widget build(BuildContext context) {
    ...
    // final EditAddressPageArgs args =
    //     ModalRoute.of(context)!.settings.arguments as EditAddressPageArgs;
    ...
    return GestureDetector(
      ...
      child: Scaffold(
          ...
          persistentFooterButtons: [
            Container(
              ...
              child: CustomButton(
                onClickBtn: () {
                  ...
                  editAddressManager
                      ...
                      request: AddressesRequest(
                          method: "put",
                          area:
                          "${addAddressManager.selectAreaSubject.value.id}",
                          avenue: _avenue,
                          block: _block,
                    ...
                    if (value == ManagerState.SUCCESS) {
                      if (widget.navigateFromAddresses == true) {
                ...
                txt: '${context.translate(AppStrings.UPDATE_ADDRESS)}',
          ...
          appBar: PreferredSize(
            ...
            child: MainAppBar(
              title: Text('${context.translate(AppStrings.UPDATE_ADDRESS)}'),
              hasCart: false,
            ),
          ),
                                                        ...
                                                        itemBuilder: (context, index) {
                                                          return ValueListenableBuilder<Area>(
                                                              ...
                                                              builder: (context, areaValue, _) {
                                                                return InkWell(
                                                                  onTap: () {
                                                                    _area = "${areaSearchListSnapshot.data![index].name}";
                                                                    addAddressManager
                                                                        .selectAreaSubject
                                                                        .value =
...
//// start Row of Block & street number
                                  ...
                                  CustomTextFiled(
                                    ...
                                    initialValue: _otherInstructions,
