...
class _VerificationPageState extends State<VerificationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final verificationManager = context.use<VerificationManager>();
      ...
      child: Scaffold(
        ...
        body: ValueListenableBuilder<bool>(
          ...
          builder: (_, isClicked, __) => StreamBuilder<ManagerState>(
              ...
              stream:
                  isClicked ? resendManager.state$ : verificationManager.state$,
              builder: (context, AsyncSnapshot<ManagerState> stateSnapshot) {
                return FormsStateHandling(
                  ...
                  errorMsg: isClicked
                      ...
                      : verificationManager.errorDescription,
                  onClickCloseErrorBtn: () {
                    verificationManager.inState.add(ManagerState.IDLE);
                              ...
                              TasawaaqFormContainer(
                                ...
                                onClickConfirmBtn: _code.length < 4
                                    ...
                                    : () {
                                        if (_code.length < 4) {
                                          toast.show(
                                              '${context.translate(AppStrings.OTP0)} ${context.translate(AppStrings.OTP1)} ${args.phone}');
                                          return;
                                        }
                                        verificationManager
                                            .activate(
