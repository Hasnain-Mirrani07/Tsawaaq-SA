...
class SettingRepo {
  static Future<SettingResponse> getSetting() async {
    try {
      ...
      if (error.response?.statusCode == 401 ||
        ...
        return SettingResponse.fromJsonError(
            json: error.response?.data, error: error);
      } else if (error.error is SocketException) {
        print('xXx xc ${error.error}');
        return SettingResponse.makeError(
        ...
        return SettingResponse.makeError(error: error, errorMsg: errorDescription);
      }
    }
  }
}
