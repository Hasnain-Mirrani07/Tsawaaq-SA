...
class ForgetPasswordPinCodeField extends StatefulWidget {
  final double height;
  ...
  @override
  State<StatefulWidget> createState() => _ForgetPasswordPinCodeFieldState();
}

class _ForgetPasswordPinCodeFieldState
    extends State<ForgetPasswordPinCodeField> {
  ...
  _ForgetPasswordPinCodeFieldState();
