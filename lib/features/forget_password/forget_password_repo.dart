...
import 'package:tasawaaq/features/forget_password/forget_password_response.dart';
  ...
  Future<ForgetPasswordResponse> forgetPassword(ForgetPasswordRequest request) async {
    ...
    try {
      ...
      if (error.response?.statusCode == 401 ||
        ...
        return ForgetPasswordResponse.fromJsonError(
            json: error.response?.data, error: error);
      } else if (error.error is SocketException) {
        print('xXx xc ${error.error}');
        return ForgetPasswordResponse.makeError(
